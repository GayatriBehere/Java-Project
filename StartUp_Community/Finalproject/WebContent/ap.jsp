<!--
	This is my page of  company 
	
	update the the status from apllied to accepted;
...
<% 
  ...
  PreparedStatement pstmt=con.prepareStatement("update apply set Apply=? where Product_name=?");
